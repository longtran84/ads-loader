package vn.fintechviet.ad.controller;

import vn.fintechviet.ad.dto.*;
import vn.fintechviet.ad.dto.AppAd;
import vn.fintechviet.ad.model.*;
...
import vn.fintechviet.ad.service.AdvertismentService;
...
public class AdvertismentController extends Controller {
	...
	private List<AppAd> buildDTO(List<vn.fintechviet.ad.model.AppAd> appAds) {
		List<AppAd> appAdDTOs = new ArrayList<AppAd>();
		for (vn.fintechviet.ad.model.AppAd appAd : appAds) {
			AppAd apa = new AppAd();
